...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/staff-home', [StaffDashboardController::class, 'index'])
    ...
    Route::middleware('role:super_admin')->group(function () {
        Route::get('/dashboard', [DashboardController::class, 'index'])
            ->middleware('role:super_admin,admin')
            ->name('dashboard');
        Route::get('/api/dashboard/pppoe', [DashboardController::class, 'pppoe'])
            ->name('dashboard.pppoe');
    });

    // ================================================================
    // CUSTOMER & PACKAGE: Super Admin + Admin
    // Admin diproteksi lebih detail per-area di CustomerController.
    // ================================================================
    ...
    // ================================================================
    // CUSTOMER & PACKAGE: Super Admin saja
    // ================================================================
    Route::middleware('role:super_admin')->group(function () {
    ...
    // ================================================================
    // INVOICE, PAYMENT, EXPENSE, SETTINGS, ROUTER, USER, AREA
    // Catatan: blok ini hanya mewarisi middleware 'auth' dari group
    // di atas (tanpa pembatasan role tambahan di level route),
    // kecuali payments.store dan expenses.* yang punya middleware
    // role eksplisit. Perilaku ini TIDAK diubah saat pembersihan.
    // ================================================================
    ...
    // Nonaktif sementara — sengaja dikomentari, bukan sisa error:
